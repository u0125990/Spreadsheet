...
// Kevin Claiborne added Set/Get VScroll and HScroll 3/8/2018.
...
namespace SSGui
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        /// <summary>
        /// Returns the poition of vetical scroll
        /// </summary>
        /// <returns></returns>
        public int GetVScollPosition() {
            return vScroll.Value;
        }

        /// <summary>
        /// Returns the poition of Horizontal scroll
        /// </summary>
        /// <returns></returns>
        public int GetHScollPosition() {
            return hScroll.Value;
        }

        /// <summary>
        /// Increments the poition of Horizontal scroll by v
        /// </summary>
        /// <returns></returns>
        public void SetHScollPosition(int v) {
            if (v == -1 && hScroll.Value > 0) {
                drawingPanel.HandleHScroll(this, new ScrollEventArgs(ScrollEventType.SmallIncrement, hScroll.Value += v));
            } 
        ...
        /// <summary>
        /// Increments the poition of Vertical scroll by v
        /// </summary>
        /// <returns></returns>
        public void SetVScrollPosition(int v) {
            if (v == -1 && vScroll.Value > 0) {
                drawingPanel.HandleVScroll(this, new ScrollEventArgs(ScrollEventType.SmallIncrement, vScroll.Value += v));
            }
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                if ((_selectedCol - _firstColumn >= 0) && (_selectedRow - _firstRow >= 0))
                {
                  e.Graphics.DrawRectangle(
                        new Pen(Color.FromArgb(0, 153, 255), 3),
                        ...
                        new Rectangle(LABEL_COL_WIDTH + (_selectedCol - _firstColumn) * DATA_COL_WIDTH + 1,
                                      ...
                                      DATA_COL_WIDTH - 2,
                                      DATA_ROW_HEIGHT - 2));
                   e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(40,128,128,128)), new Rectangle(LABEL_COL_WIDTH + (_selectedCol - _firstColumn) * DATA_COL_WIDTH + 1,
                                      LABEL_ROW_HEIGHT + (_selectedRow - _firstRow) * DATA_ROW_HEIGHT + 1,
                                      DATA_COL_WIDTH - 2,
                                      DATA_ROW_HEIGHT - 2)); 
